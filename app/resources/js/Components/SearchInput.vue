...
<template>
    <div class="flex">
        <div class="relative" v-bind="attrsStyles">
            ...
            <input
                class="w-full block p-2 pl-9 placeholder:text-sm dark:placeholder-gray-400 dark:bg-gray-900 dark:text-gray-300 rounded-md border border-gray-300 dark:border-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 focus:ring-gray-400 dark:focus:ring-gray-500 disabled:opacity-25 transition ease-in-out duration-500 shadow-sm" 
