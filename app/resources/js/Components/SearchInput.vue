...
<template>
    <div class="relative">
        ...
        <input
            v-bind="attrsStyles"
            class="block w-full p-2 pl-9 placeholder:text-sm dark:placeholder-gray-400 dark:bg-gray-900 dark:text-gray-300 rounded-md border-gray-300 dark:border-gray-700 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm" 
        ...
        <div v-if="showClearIcon">
            <button class="text-white absolute inset-y-2 right-2 px-2 rounded-lg text-sm dark:bg-gray-900 dark:hover:bg-gray-700 ring-0" aria-label="Clear" @mousedown="clear" @keydown.space.enter="clear">X</button>
        </div>
        <div v-if="showShortcutIcon">
            <span class="text-white absolute inset-y-2 right-2 px-2 rounded-lg text-sm p-1 dark:bg-gray-600 ring-0">/</span>
        </div>
    </div>
</template>