...
<template>
  ...
  <ToastRoot
      v-model:open="open"
      class="relative bg-secondary-light dark:bg-secondary-dark text-secondary-light dark:text-secondary-dark rounded-md shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] p-[15px] grid [grid-template-areas:_'title_action'_'description_action'] grid-cols-[auto_max-content] gap-x-[15px] items-center data-[state=open]:animate-slideIn data-[state=closed]:animate-hide data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=cancel]:translate-x-0 data-[swipe=cancel]:transition-[transform_200ms_ease-out] data-[swipe=end]:animate-swipeOut"
    >
    <ToastClose aria-label="Close" class="absolute top-0 right-2">
      ...
      <ToastDescription as-child>
        ...
        <ProgressRoot
          ...
          class="relative overflow-hidden bg-primary-light rounded-full w-full sm:w-[300px] h-1"
          style="transform: translateZ(0)"
        >
          <ProgressIndicator
            class="bg-info-light rounded-full w-full h-full transition-transform duration-[660ms] ease-[cubic-bezier(0.65, 0, 0.35, 1)]"
