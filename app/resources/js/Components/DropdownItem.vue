...
<template>
    <template v-for="item in content">
        <DropdownMenuSub v-if="item.items">
            <DropdownMenuSubTrigger
                :class="`group px-[5px] flex pl-[25px] leading-none items-center relative select-none text-sm py-3 focus:outline-none cursor-pointer bg-${
                    item.theme || 'secondary'
                }-light dark:bg-${item.theme || 'secondary'}-dark text-${
                    item.theme || 'secondary'
                }-light dark:text-${
                    item.theme || 'secondary'
                }-dark data-[state=open]:bg-${
                    item.theme || 'secondary'
                }-light-hover data-[state=open]:dark:bg-${
                    item.theme || 'secondary'
                }-dark-hover data-[highlighted]:bg-${
                    item.theme || 'secondary'
                }-light-hover data-[highlighted]:dark:bg-${
                    item.theme || 'secondary'
                }-dark-hover data-[highlighted]:text-${
                    item.theme || 'secondary'
                }-light data-[highlighted]:dark:text-${
                    item.theme || 'secondary'
                }-dark data-[highlighted]:data-[state=open]:bg-${
                    item.theme || 'secondary'
                }-light-hover data-[highlighted]:data-[state=open]:dark:bg-${
                    item.theme || 'secondary'
                }-dark-hover data-[disabled]:bg-${
                    item.theme || 'secondary'
                }-light/50 data-[disabled]:dark:bg-${
                    item.theme || 'secondary'
                }-dark/50 data-[disabled]:text-${
                    item.theme || 'secondary'
                }-light/50 data-[disabled]:dark:text-${
                    item.theme || 'secondary'
                }-dark/50 data-[disabled]:pointer-events-none transition ease-in-out duration-500`"
            >
