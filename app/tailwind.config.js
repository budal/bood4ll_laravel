...
export default {
    ...
    safelist: [
        ...
        {
            pattern:
                /(bg|border|text)-(zero|primary|secondary|danger|success|warning|info)-(light|dark)/,
            variants: [
                "dark",
                "hover",
                "dark:hover",
                ...
                "data-[state=open]",
                "data-[state=open]:dark",
                "data-[state=active]",
                "data-[state=active]:dark",
                "data-[state=inactive]",
                "data-[state=inactive]:dark",
                "data-[highlighted]",
                "data-[highlighted]:dark",
                "data-[highlighted]:data-[state=open]",
                "data-[highlighted]:data-[state=open]:dark",
                "data-[disabled]",
                "data-[disabled]:dark",
            ],
        },
