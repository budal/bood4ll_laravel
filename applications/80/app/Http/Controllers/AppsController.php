...
class AppsController extends Controller
{
    ...
    public function index()
    {
      $content = [
        'title' => __("Apps"),
        'subtitle' => __("Select the app you want to use"),
        'description' => __("Apps are disponible according to the groups that do you participate, whose access is located in the upper right corner of your screen."),
        ...
        'content' => [
            ...
            [
                ...
                "route" => "apps/units",
                "title" => "Units",
                "description" => "Manage all existing units and subunits in the system."
            ],
            [
